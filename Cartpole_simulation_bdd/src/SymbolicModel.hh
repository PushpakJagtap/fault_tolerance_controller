...
public:
  ...
  BDD compute_gb(const Cudd& manager, F1& system_post1, F2& radius_post1,  F3& system_post2, F4& radius_post2, size_t& no_trans) {
    return compute_gb(manager, system_post1, radius_post1, system_post2, radius_post2, [](const abs_type&) noexcept {return false;}, no_trans);
  }
  /** 
  ...
  BDD compute_gb(const Cudd& manager, F1& system_post1, F2& radius_post1, F3& system_post2, F4& radius_post2, F5&& avoid, size_t& no_trans) {
    /* number of cells */
